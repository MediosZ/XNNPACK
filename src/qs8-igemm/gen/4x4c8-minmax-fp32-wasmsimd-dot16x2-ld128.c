...
void xnn_qs8_igemm_minmax_fp32_ukernel_4x4c8__wasmsimd_dot16x2_ld128(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
  ...
  do {
    ...
    do {
      ...
      while (k < kc) {
        ...
        vacc3x1 = wasm_i32x4_add(vacc3x0, wasm_i32x4_dot_i16x8(vxa3, vxb1));
        ...
        vacc3x3 = wasm_i32x4_add(vacc3x2, wasm_i32x4_dot_i16x8(vxa3, vxb3));
    ...
    vacc3x0123 = wasm_f32x4_max(vacc3x0123, voutput_min_less_zero_point);
    ...
    vacc3x0123 = wasm_f32x4_min(vacc3x0123, voutput_max_less_zero_point);
